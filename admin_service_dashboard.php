...
.greenbtn {
    background-color: rgb(34,153,253);
    color: white;
    width: 95%;
    height: 40px;
    margin-top: 8px;
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="radio" name="branch" value="COE"/>COE<input type="radio" name="branch" value="MCE"/>MCE<div style="margin-left:80px"><input type="radio" name="branch" value="SE"/>SE<input type="radio" name="branch" value="IT"/>IT</div>
            </div>   
